...
let AppGateway = class AppGateway {
    ...
    emitOrderAssigned(orderId, riderName, estimatedTime) {
    ...
    emitRiderOffline(riderId, reassignedOrders) {
        this.server.to('admin').emit('rider_offline', { riderId, reassignedOrders });
    }
    emitLocationUpdate(riderId, lat, lng) {
...
], AppGateway.prototype, "handleJoinAdmin", null);
