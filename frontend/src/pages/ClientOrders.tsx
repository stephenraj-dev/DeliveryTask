      ...
      <div className="grid grid-cols-2 md:grid-cols-5 gap-4 mb-6">
        ...
        <div className="relative overflow-hidden rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Waiting Pickup</p>
              <p className="text-2xl font-bold text-amber-600">{stats.waitingPickup}</p>
            </div>
          </div>
        ...
        <div className="relative overflow-hidden rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Waiting Delivery</p>
              <p className="text-2xl font-bold text-blue-600">{stats.waitingDelivery}</p>
            </div>
          </div>
        ...
        <div className="relative overflow-hidden rounded-xl border border-gray-200 bg-white p-4 shadow-sm">
          ...
          <div className="absolute -right-3 -bottom-3 h-16 w-16 rounded-full bg-red-50 opacity-60" />
        </div>
      </div>
      ...
      <Card title="Place New Order" className="mb-6">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div>
            ...
            <input className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none" value={pickup} onChange={e => setPickup(e.target.value)} placeholder="Enter pickup address" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Drop Address</label>
            <input className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none" value={drop} onChange={e => setDrop(e.target.value)} placeholder="Enter drop address" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Package Details</label>
            <input className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none" value={pkg} onChange={e => setPkg(e.target.value)} placeholder="Describe the package" />
          </div>
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-1">Priority</label>
            <select className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 outline-none bg-white" value={priority} onChange={e => setPriority(e.target.value as 'normal' | 'urgent')}>
              ...
              <div
                ...
                className={`p-4 border rounded-lg cursor-pointer transition-all ${
                  order.priority === 'urgent'
                    ? 'bg-red-50 border-red-200 border-l-4 border-l-red-400 hover:border-red-300 hover:bg-red-100/60'
